  ...
  const applyFilters = () => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(doc =>
        ...
        (doc.partner_name && doc.partner_name.toLowerCase().includes(searchTerm.toLowerCase())) ||
        (doc.tva && doc.tva.toString().includes(searchTerm)) ||
        (doc.total_ht && doc.total_ht.toString().includes(searchTerm)) ||
        (doc.total_ttc && doc.total_ttc.toString().includes(searchTerm))
      );
    }
                        ...
                        <tr key={document.id} className="align-middle">
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              <span className="text-truncate" title={document.filename}>
                                {document.filename}
                              </span>
                            </div>
                          </td>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="bg-light p-3 rounded">
                  <strong>{deletingDocument.filename}</strong>
                </div>
